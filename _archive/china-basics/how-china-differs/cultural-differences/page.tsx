...
export default function CulturalDifferencesPage() {
  const breadcrumbJsonLd = breadcrumbSchema([{ name: "Home", path: "/" }, { name: "China Basics", path: "/china-basics" }, { name: "How China Differs", path: "/china-basics/how-china-differs" }, { name: "Cultural Differences", path: "/china-basics/how-china-differs/cultural-differences" }]);
  return (
    <>
