...
const HERO_VIDEO_URL = 'https://cdn.pixabay.com/video/2020/07/30/46345-445736670_large.mp4'
const MOBILE_HERO_IMAGE = 'https://picsum.photos/seed/china-hero/1920/1080'
...
function HomeV6ClientInner() {
  const [openFaq, setOpenFaq] = useState(0)

  return (
    <main className="min-h-screen bg-[#f5f1ea] text-[#1a3a4a]">
      <section className="relative overflow-hidden bg-[#0f2230] text-white">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(175,93,50,0.32),transparent_34%),radial-gradient(circle_at_80%_0%,rgba(39,88,112,0.45),transparent_38%),linear-gradient(120deg,#09131b_0%,#132a38_45%,#0a1821_100%)] animate-[pulse_8s_ease-in-out_infinite]" />
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#08131b]/88 via-[#08131b]/45 to-[#08131b]/22" />

        <div className="relative mx-auto flex min-h-[78vh] max-w-6xl items-end px-4 pb-14 pt-20 md:min-h-screen md:px-6 md:pb-20 md:pt-28">
          <div className="max-w-3xl">
            <div className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-white/88 backdrop-blur-sm">
              First-trip China travel guide
            </div>
            <h1 className="mt-6 max-w-3xl text-4xl font-bold leading-[1.02] text-white sm:text-5xl md:text-6xl lg:text-7xl">
              Your First Trip to China
              <span className="block text-[#f1cbb4]">— Simplified</span>
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-7 text-white/82 sm:text-lg">
              Visa-free entry for 30+ countries. Practical guides, honest advice, and ready-made
              itineraries.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                href="/china-basics"
                className="inline-flex min-h-[48px] items-center justify-center rounded-xl border border-white/50 bg-white/12 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-white hover:text-[#1a3a4a]"
              >
      ...
      <section className="bg-white py-14 md:py-20">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <div className="mb-8 max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-bold sm:text-4xl">
              The practical stuff that changes your trip
            </h2>
            <p className="mt-3 text-base leading-7 text-[#1a3a4a]/72">
...
const HomeV6Client = dynamic(() => Promise.resolve(HomeV6ClientInner), {
  ssr: false,
  loading: () => (
