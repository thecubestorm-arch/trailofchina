      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <nav aria-label="breadcrumb" className="mb-8">
          <ol className="flex items-center gap-2 text-sm text-[#64748b]">
            <li>
              <a href="/" className="text-[#af5d32] hover:underline">Home</a>
            </li>
        ...
        {/* Info cards linking to real pages */}
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <a href="/china-basics/" className="block p-6 bg-[#f5f1ea] rounded-xl border border-[#ebe4d8] hover:border-[#af5d32] transition-colors">
          ...
          <a href="/destinations/" className="block p-6 bg-[#f5f1ea] rounded-xl border border-[#ebe4d8] hover:border-[#af5d32] transition-colors">
          ...
          <a href="/plan-your-trip/" className="block p-6 bg-[#f5f1ea] rounded-xl border border-[#ebe4d8] hover:border-[#af5d32] transition-colors">
