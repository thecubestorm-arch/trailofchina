...
const HeroMiniMap = dynamic(() => import('./HeroMiniMap'), {
  ssr: false,
  loading: () => (
    <div className="h-[300px] w-full animate-pulse rounded-[1.4rem] bg-[#f5f1ea] md:h-[350px]" />
  ),
})
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 pb-14 pt-10 md:px-6 md:pb-20 md:pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-[#1a3a4a]/10 bg-white p-3 shadow-[0_24px_80px_rgba(26,58,74,0.12)]">
              <div className="rounded-[1.4rem] bg-[#f8f5ef] p-3 sm:p-4">
                <div className="mb-3 flex items-center justify-between gap-4">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#af5d32]">
                      Fast orientation for first-timers
                    </p>
                    <p className="mt-1 text-sm text-[#1a3a4a]/70">
                      Start with the essentials, then choose a route that fits your trip.
                    </p>
                  </div>
                </div>
                <HeroMiniMap />
                <Link
                  href="/destinations"
                  className="mt-4 inline-flex items-center text-sm font-semibold text-[#af5d32] transition-colors hover:text-[#97502b]"
                >
...
const HomeV5Client = dynamic(() => Promise.resolve(HomeV5ClientInner), {
  ssr: false,
  loading: () => (
