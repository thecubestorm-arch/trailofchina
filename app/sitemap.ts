...
const staticRoutes: SitemapEntry[] = [
  ...
  { path: '/destinations/beijing/jianbing', changeFrequency: 'monthly', priority: 0.9 },
  ...
  { path: '/destinations/shanghai/shanghai-tower', changeFrequency: 'monthly', priority: 0.9 },
  ...
  { path: '/destinations/shenzhen/ping-an-finance-centre', changeFrequency: 'monthly', priority: 0.9 },
