...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Shanghai\'s iconic waterfront promenade with colonial-era buildings and the Pudong skyline. Free to visit, best at sunset.',
    url: 'https://trailofchina.com/destinations/shanghai/what-to-do/bund-gallery-b',
    type: 'website',
  },
};
...
export default function BundGalleryBPage() {
  return (
    <div className="min-h-screen" style={{
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {/* Mobile: gallery FIRST, then text */}
        <div className="flex flex-col md:grid md:grid-cols-5 md:gap-10 mb-12">
          ...
          {/* RIGHT COLUMN: Airbnb Gallery (40% on desktop) */}
          <div className="md:col-span-2 order-1 md:order-2 mb-6 md:mb-0">
            <AirbnbGallery items={galleryItems} />
          </div>
        </div>
