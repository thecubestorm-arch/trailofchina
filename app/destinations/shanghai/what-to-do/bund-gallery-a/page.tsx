...
import TripAdvisorGallery from '@/components/TripAdvisorGallery';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Shanghai\'s iconic waterfront promenade with colonial-era buildings and the Pudong skyline. Free to visit, best at sunset.',
    url: 'https://trailofchina.com/destinations/shanghai/what-to-do/bund-gallery-a',
    type: 'website',
  },
};
...
export default function BundGalleryAPage() {
  return (
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="flex flex-col md:grid md:grid-cols-5 md:gap-10 mb-12">
          ...
          <div className="md:col-span-2 order-1 md:order-2 mb-6 md:mb-0">
            <TripAdvisorGallery items={galleryItems} />
          </div>
        </div>
