...
export const beijingConfig: CityHubConfig = {
  ...
  allItems: [
    ...
    { id: "beijing-itinerary", name: "1-2-3 Day Beijing Itineraries", subtitle: "Hour-by-hour plans for Forbidden City, Great Wall, Summer Palace.", imageSeed: "", href: "/destinations/beijing/1-2-3-day-itinerary", type: "info", icon: Calendar, filters: ["practical"] },
    { id: "beijing-transport-guide", name: "Beijing Transport Guide", subtitle: "Metro (¥3-9), DiDi, taxi, Airport Express, bike sharing.", imageSeed: "", href: "/destinations/beijing/transport-guide", type: "info", icon: TrainFront, filters: ["practical"] },
  ],
