...
const tocItems = [
  { id: 'must-see', title: 'Must-See Attractions' },
  { id: 'great-wall', title: 'Great Wall Compared' },
  { id: 'hidden-gems', title: 'Hidden Gems' },
  { id: 'local-experiences', title: 'Local Experiences' },
]
        ...
        <div className="md:grid md:grid-cols-4 md:gap-10">
          <div className="md:col-span-3">
            ...
            <div className="relative mb-6">
              ...
              <h1 className="text-4xl font-bold text-[#1a3a4a]">What to Do in Beijing</h1>
            </div>
            ...
            <section className="mb-8">
              <h2 id="must-see" className="text-2xl font-semibold mb-4">Must-See Attractions</h2>
              ...
              <div className="space-y-4">
                <Link href="/destinations/beijing/what-to-do/forbidden-city" className="block border rounded-xl p-6 transition-all duration-200 hover:shadow-md hover:bg-[#fdf8f3]">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a3a4a]">1. The Forbidden City (故宫)</h3>
                  ...
                  <p className="text-sm text-[#64748b]">🕐 8:30-17:00 (closed Mondays) | 💰 ¥60 (Apr-Oct), ¥40 (Nov-Mar) | 📍 Metro: Tiananmen East (Line 1)</p>
                ...
                <Link href="/destinations/beijing/what-to-do/great-wall" className="block border rounded-xl p-6 transition-all duration-200 hover:shadow-md hover:bg-[#fdf8f3]">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a3a4a]">2. Great Wall of China (长城)</h3>
                  <p className="text-gray-700 mb-2">
                  ...
                  <p className="text-sm text-[#64748b]">🕐 7:30-17:30 (varies by section) | 💰 ¥40-65 | 📍 Bus or car from city center</p>
                  <span className="text-[#af5d32] text-sm font-normal">→ Read more</span>
                </Link>
                ...
                <Link href="/destinations/beijing/what-to-do/temple-of-heaven" className="block border rounded-xl p-6 transition-all duration-200 hover:shadow-md hover:bg-[#fdf8f3]">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a3a4a]">3. Temple of Heaven (天坛)</h3>
                  <p className="text-gray-700 mb-2">
                  ...
                  <p className="text-sm text-[#64748b]">🕐 6:00-22:00 (park), 8:00-17:30 (halls) | 💰 Park ¥15, All-access ¥34 | 📍 Metro: Tiantan Dongmen (Line 5)</p>
                  <span className="text-[#af5d32] text-sm font-normal">→ Read more</span>
                </Link>
                ...
                <Link href="/destinations/beijing/what-to-do/summer-palace" className="block border rounded-xl p-6 transition-all duration-200 hover:shadow-md hover:bg-[#fdf8f3]">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a3a4a]">4. Summer Palace (颐和园)</h3>
                  <p className="text-gray-700 mb-2">
                  ...
                  <p className="text-sm text-[#64748b]">🕐 6:00-18:00 (Nov-Mar to 17:00) | 💰 ¥30 (park), ¥60 (all-inclusive) | 📍 Metro: Beigongmen (Line 4)</p>
                  <span className="text-[#af5d32] text-sm font-normal">→ Read more</span>
                </Link>
                ...
                <Link href="/destinations/beijing/what-to-do/798-art-district" className="block border rounded-xl p-6 transition-all duration-200 hover:shadow-md hover:bg-[#fdf8f3]">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a3a4a]">5. 798 Art District (798艺术区)</h3>
                  <p className="text-gray-700 mb-2">
                  ...
                  <p className="text-sm text-[#64748b]">🕐 10:00-18:00 (most galleries) | 💰 Free entry, some exhibitions ¥50-80 | 📍 Dashanzi area, 🚇 Metro: Jiangtai (Line 14)</p>
                  <span className="text-[#af5d32] text-sm font-normal">→ Read more</span>
                </Link>
                ...
                <Link href="/destinations/beijing/what-to-do/lama-temple" className="block border rounded-xl p-6 transition-all duration-200 hover:shadow-md hover:bg-[#fdf8f3]">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a3a4a]">6. Lama Temple (雍和宫)</h3>
                  <p className="text-gray-700 mb-2">
                  ...
                  <p className="text-sm text-[#64748b]">🕐 9:00-16:30 | 💰 ¥25 | 📍 Metro: Yonghegong (Lines 2/5)</p>
                  <span className="text-[#af5d32] text-sm font-normal">→ Read more</span>
                </Link>
                ...
                <Link href="/destinations/beijing/what-to-do/hutong" className="block border rounded-xl p-6 transition-all duration-200 hover:shadow-md hover:bg-[#fdf8f3]">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a3a4a]">7. Bell and Drum Towers (钟鼓楼)</h3>
                  <p className="text-gray-700 mb-2">
                  ...
                  <p className="text-sm text-[#64748b]">🕐 9:00-17:00 | 💰 ¥20 (combined ticket) | 📍 Gulou area, 🚇 Metro: Gulou Dajie (Line 8)</p>
                  <span className="text-[#af5d32] text-sm font-normal">→ Read more</span>
                </Link>

                <Link href="/destinations/beijing/what-to-do/hutong" className="block border rounded-xl p-6 transition-all duration-200 hover:shadow-md hover:bg-[#fdf8f3]">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a3a4a]">8. Hutong Tours (胡同)</h3>
                  <p className="text-gray-700 mb-2">
                  ...
                  <p className="text-sm text-[#64748b]">🕐 Anytime | 💰 Free to walk, rickshaw ¥80-120/hr | 📍 Dongcheng/Xicheng districts</p>
                  <span className="text-[#af5d32] text-sm font-normal">→ Read more</span>
                </Link>
              </div>
            </section>
            ...
            <section className="mb-8">
              <h2 id="great-wall" className="text-2xl font-semibold mb-4">Great Wall Sections Compared</h2>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-[#64748b] mt-2">✅ Best for: Most visitors | 🚐 1.5h from Beijing | 💰 ¥40 entry + ¥120 cable car</p>
                </div>
                ...
                <div className="bg-amber-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-[#64748b] mt-2">⚠️ Go before 8 AM or skip | 🚐 1h from Beijing | 💰 ¥40 | Bus 877 from Deshengmen</p>
                </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-[#64748b] mt-2">🥾 Best for: Hikers | 🚐 2.5h from Beijing | 💰 ¥65 | Stunning sunrises</p>
                </div>
              </div>
            </section>

            <section className="mb-8">
              <h2 id="hidden-gems" className="text-2xl font-semibold mb-4">Hidden Gems</h2>
            ...
            <section className="mb-8 bg-[#fdf8f3] rounded-xl p-6" id="local-experiences">
