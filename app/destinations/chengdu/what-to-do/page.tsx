        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <article className="border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">1. Chengdu Research Base of Giant Panda (成都大熊猫繁育研究基地)</h3>
            ...
            <article className="border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">2. Jinli Ancient Street (锦里古街)</h3>
              <p className="text-gray-700 mb-2">
            ...
            <article className="border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">3. Wenshu Monastery (文殊院)</h3>
              <p className="text-gray-700 mb-2">
            ...
            <article className="border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">4. People&apos;s Park Teahouse (人民公园)</h3>
              <p className="text-gray-700 mb-2">
            ...
            <article className="border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">5. Sichuan Opera Face-Changing (川剧变脸)</h3>
              <p className="text-gray-700 mb-2">
            ...
            <article className="border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">6. Kuanzhai Alley (宽窄巷子)</h3>
              <p className="text-gray-700 mb-2">
