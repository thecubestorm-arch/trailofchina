...
export default function VpnGuidePageTest5() {
  return (
    <div>
      <GuideArticlePage
      ...
      >
        {
          <>
            ...
            <div className="mt-8 rounded-2xl border-2 border-amber-300 bg-amber-50 p-6 shadow-sm">
              <div className="flex items-center gap-2">
                <span className="text-2xl">📶</span>
                <h2 className="text-xl font-extrabold text-amber-900">No VPN? Roaming is your backup</h2>
              </div>
              <p className="mt-3 text-sm leading-relaxed text-slate-700 md:text-base">
              ...
              <p className="mt-3 text-sm font-bold text-amber-800">
                Your home SIM bypasses the Great Firewall entirely
              </p>
              <p className="mt-2 text-sm text-amber-800">
                ⚠️ Expensive but works in a pinch
              </p>
            </div>
          </>
        }
