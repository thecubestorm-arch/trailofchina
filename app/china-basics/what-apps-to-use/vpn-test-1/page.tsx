...
export default function VpnGuidePageTest1() {
  return (
    <div>
      <GuideArticlePage
            ...
            <div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-3 sm:grid-cols-5">
                {blockedApps.map((app) => (
                  <div
                    key={app.name}
                    className="relative flex flex-col items-center rounded-xl border border-red-200 bg-red-50 p-3"
                  >
                    <span className="text-2xl">{app.icon}</span>
                    <span className="mt-1 text-xs font-semibold text-red-800 line-through">
                      {app.name}
                    </span>
              ...
              <p className="mt-4 text-center text-sm font-bold text-red-700 md:text-base">
                Without a VPN, these are ALL inaccessible in China
              </p>
