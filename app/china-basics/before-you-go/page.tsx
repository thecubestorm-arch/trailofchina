...
export const metadata: Metadata = makeMetadata({
  title: 'Before You Go to China | Visa, Safety & Packing',
  description:
...
export default function BeforeYouGoPage() {
  const breadcrumbJsonLd = breadcrumbSchema([{ name: "Home", path: "/" }, { name: "China Basics", path: "/china-basics" }, { name: "Before You Go", path: "/china-basics/before-you-go" }]);
  return (
    <>
