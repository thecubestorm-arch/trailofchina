...
export default function SecurityStandardsPage() {
  const breadcrumbJsonLd = breadcrumbSchema([{ name: "Home", path: "/" }, { name: "China Basics", path: "/china-basics" }, { name: "How China Differs", path: "/china-basics/how-china-differs" }, { name: "Security Standards", path: "/china-basics/how-china-differs/security-standards" }]);
  return (
    <>
